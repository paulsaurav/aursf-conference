    ...
    <div className="w-full bg-neutral-950 text-neutral-200 py-16 px-6 md:px-12 lg:px-24">
      <div className="grid md:grid-cols-2 gap-12 max-w-7xl mx-auto">
        ...
        <div className="p-8 bg-neutral-900 rounded-lg shadow-lg flex flex-col justify-between">
          ...
          The Assam University Research Scholars’ Forum (AUSRF), a vanguard for research scholars at Assam University, is privileged to organize the “International Young Researchers' Conclave and Rural Science Congress (IYRCRCS-2025)”. <br />
