  ...
  return (
    <div className="w-full bg-neutral-950 text-neutral-200 py-16 px-6 md:px-12 lg:px-24">
      <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-10 gap-12">
        ...
        <div className="md:col-span-3 p-8 bg-neutral-900 rounded-lg shadow-lg">
        ...
        <div className="md:col-span-7 p-8 bg-neutral-900 rounded-lg shadow-lg">
          ...
          {/* By Air */}
          <div className="mb-6">
            <h3 className="text-2xl font-semibold text-white mb-2">By Air</h3>
          ...
          {/* By Train */}
          <div className="mb-6">
            <h3 className="text-2xl font-semibold text-white mb-2">By Train</h3>
            <p className="text-neutral-300 leading-relaxed">
          ...
          {/* By Road */}
          <div className="mb-6">
            <h3 className="text-2xl font-semibold text-white mb-2">By Road</h3>
            <p className="text-neutral-300 leading-relaxed">
